---
title: Beta
url: https://platform.claude.com/docs/en/api/beta.md
source: llms
fetched_at: 2026-01-01T02:09:01.482062654-03:00
rendered_js: false
word_count: 11123
summary: Describes the Anthropic Beta API's structure, error handling, and models listing/retrieval endpoints with pagination and versioning support.
tags:
    - anthropic-beta-api
    - error-handling
    - models-list
