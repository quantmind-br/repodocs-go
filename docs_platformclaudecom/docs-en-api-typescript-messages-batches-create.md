---
title: Create a Message Batch (TypeScript)
url: https://platform.claude.com/docs/en/api/typescript/messages/batches/create.md
source: llms
fetched_at: 2026-01-01T02:09:52.659278865-03:00
rendered_js: false
word_count: 98
summary: Describes the Message Batches API for processing multiple message requests concurrently via a batch creation endpoint.
tags:
