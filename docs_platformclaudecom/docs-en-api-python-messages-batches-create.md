---
title: Create a Message Batch (Python)
url: https://platform.claude.com/docs/en/api/python/messages/batches/create.md
source: llms
fetched_at: 2026-01-01T02:09:51.212492803-03:00
rendered_js: false
word_count: 107
summary: Describes the Message Batches API for processing multiple message requests in parallel with configurable parameters.
tags:
