---
title: Create a Message Batch (Java)
url: https://platform.claude.com/docs/en/api/java/messages/batches/create.md
source: llms
fetched_at: 2026-01-01T02:09:49.823188769-03:00
rendered_js: false
word_count: 90
summary: Describes the Message Batches API for processing multiple message requests in parallel, including parameters for batch creation, request handling, and conversational turn management.
tags:
