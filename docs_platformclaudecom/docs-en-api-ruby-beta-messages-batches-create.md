---
title: Create a Message Batch (Beta) (Ruby)
url: https://platform.claude.com/docs/en/api/ruby/beta/messages/batches/create.md
source: llms
fetched_at: 2026-01-01T02:09:47.568140614-03:00
rendered_js: false
word_count: 137
summary: Describes the beta API endpoint for creating message batches to process multiple prompt completions efficiently.
tags:
