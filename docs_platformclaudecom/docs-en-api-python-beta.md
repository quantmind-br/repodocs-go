---
title: Beta
url: https://platform.claude.com/docs/en/api/python/beta.md
source: llms
fetched_at: 2026-01-01T02:09:04.124882424-03:00
rendered_js: false
word_count: 7815
summary: Describes the Anthropic Beta API framework, including model listing, retrieval, and error handling for beta features and authentication.
tags:
    - anthropic-beta-api
    - models-api
    - error-handling
