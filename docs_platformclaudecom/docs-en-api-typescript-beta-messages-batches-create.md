---
title: Create a Message Batch (Beta) (TypeScript)
url: https://platform.claude.com/docs/en/api/typescript/beta/messages/batches/create.md
source: llms
fetched_at: 2026-01-01T02:09:48.289909596-03:00
rendered_js: false
word_count: 100
summary: Describes the API endpoint for creating batches of message requests in Claude’s API, enabling parallel processing of multiple prompts.
tags:
