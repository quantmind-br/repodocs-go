---
title: Beta
url: https://platform.claude.com/docs/en/api/ruby/beta.md
source: llms
fetched_at: 2026-01-01T02:09:04.916731783-03:00
rendered_js: false
word_count: 7709
summary: Describes the Anthropic Beta API structure, including domain types, error handling, and models listing/retrieval endpoints with pagination and version-specific configurations.
tags:
    - anthropic-beta-api
    - error-handling
    - models-api
