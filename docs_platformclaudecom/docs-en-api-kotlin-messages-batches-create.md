---
title: Create a Message Batch (Kotlin)
url: https://platform.claude.com/docs/en/api/kotlin/messages/batches/create.md
source: llms
fetched_at: 2026-01-01T02:09:50.559759871-03:00
rendered_js: false
word_count: 91
summary: Explains how to use the Message Batches API for parallel processing of multiple message requests with configurable parameters and constraints.
tags:
