---
title: Create a Message Batch (Ruby)
url: https://platform.claude.com/docs/en/api/ruby/messages/batches/create.md
source: llms
fetched_at: 2026-01-01T02:09:51.905404338-03:00
rendered_js: false
word_count: 115
summary: Explains how to use the Message Batches API for batch processing multiple message requests in Claude.
tags:
