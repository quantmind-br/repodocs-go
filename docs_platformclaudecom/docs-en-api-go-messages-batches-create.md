---
title: Create a Message Batch (Go)
url: https://platform.claude.com/docs/en/api/go/messages/batches/create.md
source: llms
fetched_at: 2026-01-01T02:09:49.055938645-03:00
rendered_js: false
word_count: 89
summary: Describes the Message Batches API for processing multiple message requests in parallel, including parameters, request structure, and processing timelines.
tags:
