---
title: Batches
url: https://platform.claude.com/docs/en/api/kotlin/beta/messages/batches.md
source: llms
fetched_at: 2026-01-01T02:08:54.594071735-03:00
rendered_js: false
word_count: 733
summary: Describes the Message Batches API for processing multiple Message API requests in parallel, including creation, parameters, and processing timelines.
tags:
