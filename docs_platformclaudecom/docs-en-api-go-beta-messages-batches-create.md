---
title: Create a Message Batch (Beta) (Go)
url: https://platform.claude.com/docs/en/api/go/beta/messages/batches/create.md
source: llms
fetched_at: 2026-01-01T02:09:44.46323984-03:00
rendered_js: false
word_count: 91
summary: Explains how to use the Message Batches API for batching multiple message creation requests in Claude.
tags:
