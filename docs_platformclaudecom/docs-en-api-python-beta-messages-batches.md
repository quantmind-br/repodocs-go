---
title: Batches
url: https://platform.claude.com/docs/en/api/python/beta/messages/batches.md
source: llms
fetched_at: 2026-01-01T02:08:55.266654565-03:00
rendered_js: false
word_count: 930
summary: Describes the Message Batches API for processing multiple message requests in parallel, including parameters, request structure, and batch processing workflow.
tags:
