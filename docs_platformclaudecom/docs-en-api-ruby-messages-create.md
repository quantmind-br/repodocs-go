---
title: Create a Message (Ruby)
url: https://platform.claude.com/docs/en/api/ruby/messages/create.md
source: llms
fetched_at: 2026-01-01T02:09:41.31712052-03:00
rendered_js: false
word_count: 1023
summary: Describes the Messages API for Claude, detailing how to structure input messages for conversational interactions with text or image content.
tags:
    - api-messages
    - conversational-ai
    - structured-input
