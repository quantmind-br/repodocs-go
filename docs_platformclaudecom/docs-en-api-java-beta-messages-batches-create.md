---
title: Create a Message Batch (Beta) (Java)
url: https://platform.claude.com/docs/en/api/java/beta/messages/batches/create.md
source: llms
fetched_at: 2026-01-01T02:09:45.204420922-03:00
rendered_js: false
word_count: 92
summary: Describes the Message Batches API for processing multiple message requests in parallel with configurable parameters and beta versions.
tags:
