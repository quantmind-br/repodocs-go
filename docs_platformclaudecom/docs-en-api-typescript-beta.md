---
title: Beta
url: https://platform.claude.com/docs/en/api/typescript/beta.md
source: llms
fetched_at: 2026-01-01T02:09:05.619981926-03:00
rendered_js: false
word_count: 5132
summary: Describes the Anthropic Beta API's models listing and retrieval functionality, including pagination, error handling, and beta version specifications.
tags:
    - anthropic-beta-api
    - models-list
    - models-retrieve
